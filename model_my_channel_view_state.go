...
type _MyChannelViewState MyChannelViewState
...
func (o *MyChannelViewState) UnmarshalJSON(data []byte) (err error) {
	...
	varMyChannelViewState := _MyChannelViewState{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varMyChannelViewState)

	if err != nil {
		return err
	}

	*o = MyChannelViewState(varMyChannelViewState)
