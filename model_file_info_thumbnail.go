...
type _FileInfoThumbnail FileInfoThumbnail
...
func (o *FileInfoThumbnail) UnmarshalJSON(data []byte) (err error) {
	...
	varFileInfoThumbnail := _FileInfoThumbnail{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFileInfoThumbnail)

	if err != nil {
		return err
	}

	*o = FileInfoThumbnail(varFileInfoThumbnail)
