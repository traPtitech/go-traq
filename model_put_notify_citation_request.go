...
type _PutNotifyCitationRequest PutNotifyCitationRequest
...
func (o *PutNotifyCitationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPutNotifyCitationRequest := _PutNotifyCitationRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPutNotifyCitationRequest)

	if err != nil {
		return err
	}

	*o = PutNotifyCitationRequest(varPutNotifyCitationRequest)
