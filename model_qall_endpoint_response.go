...
type _QallEndpointResponse QallEndpointResponse
...
func (o *QallEndpointResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varQallEndpointResponse := _QallEndpointResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQallEndpointResponse)

	if err != nil {
		return err
	}

	*o = QallEndpointResponse(varQallEndpointResponse)
