...
type StampAPIGetMyStampRecommendationsRequest struct {
	ctx        context.Context
	ApiService *StampAPIService
	limit      *int32
}
...
// 件数
func (r StampAPIGetMyStampRecommendationsRequest) Limit(limit int32) StampAPIGetMyStampRecommendationsRequest {
	r.limit = &limit
	return r
}
...
スタンプを使用したことがないユーザーの場合は空配列が返されます。
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return StampAPIGetMyStampRecommendationsRequest
*/
func (a *StampAPIService) GetMyStampRecommendations(ctx context.Context) StampAPIGetMyStampRecommendationsRequest {
	return StampAPIGetMyStampRecommendationsRequest{
		ApiService: a,
		ctx:        ctx,
	}
