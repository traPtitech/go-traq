...
// checks if the PostClipFolderMessageRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostClipFolderMessageRequest{}
...
type _PostClipFolderMessageRequest PostClipFolderMessageRequest
...
func (o *PostClipFolderMessageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPostClipFolderMessageRequest := _PostClipFolderMessageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostClipFolderMessageRequest)

	if err != nil {
		return err
	}

	*o = PostClipFolderMessageRequest(varPostClipFolderMessageRequest)
